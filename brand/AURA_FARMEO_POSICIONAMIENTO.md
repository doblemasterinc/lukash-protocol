...
clutch o cringe es una acción) coincide EXACTAMENTE con el nombre que ya elegimos para el sistema
de reputación on-chain: **Aura**. Convergencia cultural gratis: el producto ya habla el idioma
nativo de la audiencia <45. No hay que educar sobre "qué es Aura" — ya lo saben y lo desean.
...
## Decisiones de alcance (2026-08-20)
...
- Integrar "farmear aura" en taglines y en el diseño de las Misiones de Caza (spec 01).
- Evaluar DefiLand + otros referentes pixel al arrancar diseño de la App (F2).
